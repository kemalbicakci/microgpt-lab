"""
Alıştırma 3 — test_temperature.py
Temperature değerini komut satırı argümanı olarak alır ve yeni isimler üretir.
...
# ── Argüman ayrıştırıcı ───────────────────────────────────────────────────────
parser = argparse.ArgumentParser(description='microGPT Türkçe isim üretici')
parser.add_argument('--temperature', type=float, default=0.5,
                    help='Örnekleme sıcaklığı (varsayılan: 0.5). '
                         'Düşük = belirli/tekrarlayan, Yüksek = yaratıcı/rastgele')
parser.add_argument('--num_samples', type=int, default=20,
                    help='Üretilecek isim sayısı (varsayılan: 20)')
...
if temperature <= 0:
    parser.error("Temperature 0'dan büyük olmalıdır.")
...
# ── Çıkarım ───────────────────────────────────────────────────────────────────
print(f"\n--- Çıkarım | temperature={temperature} ---")
